...
module VictorOpsClient
  ...
  class TeamAdminsResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'teamAdmins')
        if (value = attributes[:'teamAdmins']).is_a?(Array)
          self.team_admins = value
        end
      end
    end
