...
module VictorOpsClient
  class Reroute
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'addTargets')
        self.add_targets = attributes[:'addTargets']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @incident_number.nil?
        invalid_properties.push('invalid value for "incident_number", incident_number cannot be nil.')
      end
    ...
    def valid?
      return false if @incident_number.nil?
    ...
    def hash
      [incident_number, targets, add_targets].hash
    end
