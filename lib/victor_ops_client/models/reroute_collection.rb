...
module VictorOpsClient
  class RerouteCollection
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reroutes')
        if (value = attributes[:'reroutes']).is_a?(Array)
          self.reroutes = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @reroutes.nil?
        invalid_properties.push('invalid value for "reroutes", reroutes cannot be nil.')
      end
