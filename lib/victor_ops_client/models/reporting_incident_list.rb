...
module VictorOpsClient
  ...
  class ReportingIncidentList
    ...
    # The list of incidents matching the supplied parameters, up to the provided limit.
    ...
    def self.swagger_types
      {
        ...
        :'limit' => :'Integer',
        :'total' => :'Integer',
        :'incidents' => :'Array<ReportingIncidentInfo>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'incidents')
    ...
    def hash
      [offset, limit, total, incidents].hash
    end
