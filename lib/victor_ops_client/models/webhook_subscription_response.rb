...
module VictorOpsClient
  class WebhookSubscriptionResponse
    ...
    # Short description of this subscription
    attr_accessor :description

    # URL that webhooks get POSTed to.
    attr_accessor :url
    ...
    # What state the subscription is in.
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['active', 'disabled', 'halted'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['active', 'disabled', 'halted'])
    ...
    def hash
      [name, description, url, events, id, status].hash
    end
