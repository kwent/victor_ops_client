...
module VictorOpsClient
  class AckOrResolveRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'incidentNames')
        if (value = attributes[:'incidentNames']).is_a?(Array)
          self.incident_names = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @incident_names.nil?
        invalid_properties.push('invalid value for "incident_names", incident_names cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @incident_names.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          incident_names == o.incident_names &&
          message == o.message
    end
    ...
    def hash
      [user_name, incident_names, message].hash
    end
