...
module VictorOpsClient
  class UserSchedule
    ...
    def self.swagger_types
      {
        :'team_schedules' => :'Array<TeamSchedule>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'teamSchedules')
        if (value = attributes[:'teamSchedules']).is_a?(Array)
          self.team_schedules = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          team_schedules == o.team_schedules
    end
