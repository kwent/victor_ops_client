...
module VictorOpsClient
  class EscalationPolicyGroup
    # The duration in minutes to wait until executing this step since the last step was executed.  This value may be 0. This implies that this policy step should immediately execute.
    attr_accessor :timeout

    # A list of entries that this escalation policy group encapsulates. These entries will all be executed once the escalation policy reaches this step.
    ...
    def self.swagger_types
      {
        :'timeout' => :'Integer',
        :'entries' => :'Array<EscalationPolicyEntry>'
      }
    end
