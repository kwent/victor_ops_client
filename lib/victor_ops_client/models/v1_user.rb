...
module VictorOpsClient
  ...
  class V1User
    ...
    attr_accessor :password_last_updated
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'passwordLastUpdated')
        self.password_last_updated = attributes[:'passwordLastUpdated']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          password_last_updated == o.password_last_updated &&
          verified == o.verified &&
    ...
    def hash
      [first_name, last_name, username, email, created_at, password_last_updated, verified, _self_url].hash
    end
