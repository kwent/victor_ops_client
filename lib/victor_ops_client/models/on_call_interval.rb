...
module VictorOpsClient
  class OnCallInterval
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'escalationPolicy')
        self.escalation_policy = attributes[:'escalationPolicy']
      end
    end
    ...
    def hash
      [on, off, duration, escalation_policy].hash
    end
