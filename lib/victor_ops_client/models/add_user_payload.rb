...
module VictorOpsClient
  ...
  class AddUserPayload
    ...
    attr_accessor :expiration_hours
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'expirationHours')
        self.expiration_hours = attributes[:'expirationHours']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          email == o.email &&
          admin == o.admin &&
          expiration_hours == o.expiration_hours
    end
    ...
    def hash
      [first_name, last_name, username, email, admin, expiration_hours].hash
    end
