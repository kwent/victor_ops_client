...
module VictorOpsClient
  ...
  class ListRoutingKeysResponse
    ...
    def self.swagger_types
      {
        :'routing_keys' => :'Array<RoutingKeyInfo>',
        :'_self_url' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'routingKeys')
        if (value = attributes[:'routingKeys']).is_a?(Array)
          self.routing_keys = value
        end
      end
