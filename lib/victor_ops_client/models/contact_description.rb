...
module VictorOpsClient
  class ContactDescription
    ...
    EMAIL_ADDRESS = 'Email Address'.freeze
    PHONE_NUMBER = 'Phone Number'.freeze

    # Builds the enum from string
    # @param [String] The enum value in the form of the string
    # @return [String] The enum value
    def build_from_hash(value)
      constantValues = ContactDescription.constants.select { |c| ContactDescription::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #ContactDescription" if constantValues.empty?
      value
    end
  end
end
