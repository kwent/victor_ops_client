...
module VictorOpsClient
  class RotationGroup
    # The team associated with this rotation group  The team slug is in the format `team-[\\w\\d]{16}`
    attr_accessor :team_slug

    # A unique identifier for this rotation group  The slug is in the format `rtg-[\\w\\d]{16}`
    attr_accessor :slug

    # The name of this rotation group
    attr_accessor :label
