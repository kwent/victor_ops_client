...
module VictorOpsClient
  class UserLog
    ...
    def self.swagger_types
      {
        :'user_id' => :'String',
        :'total' => :'Object',
        :'adjusted_total' => :'Object',
        :'log' => :'Array<OnCallInterval>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'adjustedTotal')
        self.adjusted_total = attributes[:'adjustedTotal']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          user_id == o.user_id &&
          total == o.total &&
          adjusted_total == o.adjusted_total &&
          log == o.log
    end
    ...
    def hash
      [user_id, total, adjusted_total, log].hash
    end
