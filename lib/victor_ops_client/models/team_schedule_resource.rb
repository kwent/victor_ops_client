...
module VictorOpsClient
  class TeamScheduleResource
    ...
    def self.swagger_types
      {
        ...
        :'shift_name' => :'String',
        :'shift_roll' => :'Float',
        :'rolls' => :'Array<TeamScheduleRollResource>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'oncall')
        self.oncall = attributes[:'oncall']
      end

      if attributes.has_key?(:'overrideoncall')
        self.overrideoncall = attributes[:'overrideoncall']
      end

      if attributes.has_key?(:'policyType')
        self.policy_type = attributes[:'policyType']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          oncall == o.oncall &&
          overrideoncall == o.overrideoncall &&
    ...
    def hash
      [oncall, overrideoncall, policy_type, rotation_name, shift_name, shift_roll, rolls].hash
    end
