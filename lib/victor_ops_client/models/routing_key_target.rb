...
module VictorOpsClient
  ...
  class RoutingKeyTarget
    ...
    attr_accessor :policy_slug

    attr_accessor :_team_url
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'policySlug')
        self.policy_slug = attributes[:'policySlug']
      end

      if attributes.has_key?(:'_teamUrl')
        self._team_url = attributes[:'_teamUrl']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_slug == o.policy_slug &&
          _team_url == o._team_url
    end
    ...
    def hash
      [policy_name, policy_slug, _team_url].hash
    end
