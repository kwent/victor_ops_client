...
module VictorOpsClient
  class MaintenanceModeState
    ...
    attr_accessor :active_instances
    ...
    def self.swagger_types
      {
        :'company_id' => :'String',
        :'active_instances' => :'Array<ActiveMaintenanceMode>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'activeInstances')
        if (value = attributes[:'activeInstances']).is_a?(Array)
          self.active_instances = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          active_instances == o.active_instances
    end
    ...
    def hash
      [company_id, active_instances].hash
    end
