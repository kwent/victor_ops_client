...
module VictorOpsClient
  class CreateIncidentRequest
    ...
    attr_accessor :is_multi_responder
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isMultiResponder')
        self.is_multi_responder = attributes[:'isMultiResponder']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          targets == o.targets &&
          is_multi_responder == o.is_multi_responder
    end
    ...
    def hash
      [summary, details, user_name, targets, is_multi_responder].hash
    end
