...
module VictorOpsClient
  class OnCallTeamsResource
    ...
    def self.swagger_types
      {
        ...
        :'on_call_now' => :'Array<OnCallNowResource>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'onCallNow')
        if (value = attributes[:'onCallNow']).is_a?(Array)
          self.on_call_now = value
        end
      end
    end
