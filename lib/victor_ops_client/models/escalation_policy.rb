...
module VictorOpsClient
  class EscalationPolicy
    ...
    # A unique identifier for this escalation polcy  This slug is in the format `pol-[\\w\\d]{16}`
    attr_accessor :slug
    ...
    # A list of groupings of entries. Each group is a \"step\" in the escalation policy. Each \"step\" contains a group of entries to be executed.
    attr_accessor :steps
    ...
    def self.swagger_types
      {
        ...
        :'steps' => :'Array<EscalationPolicyGroup>'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @ignore_custom_paging_policies.nil?
        invalid_properties.push('invalid value for "ignore_custom_paging_policies", ignore_custom_paging_policies cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ignore_custom_paging_policies.nil?
    ...
    def hash
      [name, slug, ignore_custom_paging_policies, steps].hash
    end
