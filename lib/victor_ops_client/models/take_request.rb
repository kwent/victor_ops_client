...
module VictorOpsClient
  class TakeRequest
    ...
    def list_invalid_properties
      ...
      if @from_user.nil?
        invalid_properties.push('invalid value for "from_user", from_user cannot be nil.')
      end

      if @to_user.nil?
        invalid_properties.push('invalid value for "to_user", to_user cannot be nil.')
      end
