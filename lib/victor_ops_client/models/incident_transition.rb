...
module VictorOpsClient
  ...
  class IncidentTransition
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'manually')
        self.manually = attributes[:'manually']
      end

      if attributes.has_key?(:'alertId')
        self.alert_id = attributes[:'alertId']
      end

      if attributes.has_key?(:'alertUrl')
        self.alert_url = attributes[:'alertUrl']
      end
    end
    ...
    def hash
      [name, at, by, message, manually, alert_id, alert_url].hash
    end
