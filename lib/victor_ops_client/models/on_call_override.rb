...
module VictorOpsClient
  class OnCallOverride
    attr_accessor :orig_on_call_user
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'origOnCallUser')
        self.orig_on_call_user = attributes[:'origOnCallUser']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          orig_on_call_user == o.orig_on_call_user &&
    ...
    def hash
      [orig_on_call_user, override_on_call_user, start, _end].hash
    end
