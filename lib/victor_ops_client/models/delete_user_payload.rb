...
module VictorOpsClient
  ...
  class DeleteUserPayload
    ...
    attr_accessor :replacement_strategy
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'replacement')
        self.replacement = attributes[:'replacement']
      end

      if attributes.has_key?(:'replacementStrategy')
        self.replacement_strategy = attributes[:'replacementStrategy']
      end
    end
    ...
    def valid?
      replacement_strategy_validator = EnumAttributeValidator.new('String', ['specifiedUser', 'globalAdmin', 'teamAdmin', 'findReplacement'])
      return false unless replacement_strategy_validator.valid?(@replacement_strategy)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] replacement_strategy Object to be assigned
    def replacement_strategy=(replacement_strategy)
      validator = EnumAttributeValidator.new('String', ['specifiedUser', 'globalAdmin', 'teamAdmin', 'findReplacement'])
      unless validator.valid?(replacement_strategy)
        fail ArgumentError, 'invalid value for "replacement_strategy", must be one of #{validator.allowable_values}.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          replacement_strategy == o.replacement_strategy
    end
    ...
    def hash
      [replacement, replacement_strategy].hash
    end
