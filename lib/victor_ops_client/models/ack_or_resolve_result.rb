...
module VictorOpsClient
  ...
  class AckOrResolveResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cmdAccepted')
        self.cmd_accepted = attributes[:'cmdAccepted']
      end
    ...
    def hash
      [incident_number, entity_id, cmd_accepted, message].hash
    end
