...
module VictorOpsClient
  class OnCallLog
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'userLogs')
        if (value = attributes[:'userLogs']).is_a?(Array)
          self.user_logs = value
        end
      end
    end
    ...
    def hash
      [team_slug, start, _end, user_logs].hash
    end
