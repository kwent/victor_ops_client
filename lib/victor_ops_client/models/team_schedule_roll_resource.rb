...
module VictorOpsClient
  class TeamScheduleRollResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isRoll')
        self.is_roll = attributes[:'isRoll']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @change.nil?
        invalid_properties.push('invalid value for "change", change cannot be nil.')
      end
      ...
      if @is_roll.nil?
        invalid_properties.push('invalid value for "is_roll", is_roll cannot be nil.')
      end
    ...
    def hash
      [change, _until, oncall, is_roll].hash
    end
