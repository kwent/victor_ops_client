...
# Unit tests for VictorOpsClient::TakeRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TakeRequest' do
  before do
    # run before each test
    @instance = VictorOpsClient::TakeRequest.new
  end
  ...
  describe 'test an instance of TakeRequest' do
    it 'should create an instance of TakeRequest' do
      expect(@instance).to be_instance_of(VictorOpsClient::TakeRequest)
    end
  end
  ...
  describe 'test attribute "to_user"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
