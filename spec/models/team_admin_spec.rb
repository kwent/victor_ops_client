...
# Unit tests for VictorOpsClient::TeamAdmin
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TeamAdmin' do
  before do
    # run before each test
    @instance = VictorOpsClient::TeamAdmin.new
  end
  ...
  describe 'test an instance of TeamAdmin' do
    it 'should create an instance of TeamAdmin' do
      expect(@instance).to be_instance_of(VictorOpsClient::TeamAdmin)
    end
  end
