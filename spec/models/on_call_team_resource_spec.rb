...
# Unit tests for VictorOpsClient::OnCallTeamResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnCallTeamResource' do
  before do
    # run before each test
    @instance = VictorOpsClient::OnCallTeamResource.new
  end
  ...
  describe 'test an instance of OnCallTeamResource' do
    it 'should create an instance of OnCallTeamResource' do
      expect(@instance).to be_instance_of(VictorOpsClient::OnCallTeamResource)
    end
  end
