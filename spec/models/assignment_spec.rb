...
# Unit tests for VictorOpsClient::Assignment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Assignment' do
  before do
    # run before each test
    @instance = VictorOpsClient::Assignment.new
  end
  ...
  describe 'test an instance of Assignment' do
    it 'should create an instance of Assignment' do
      expect(@instance).to be_instance_of(VictorOpsClient::Assignment)
    end
  end
