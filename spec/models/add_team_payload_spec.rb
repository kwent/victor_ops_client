...
# Unit tests for VictorOpsClient::AddTeamPayload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddTeamPayload' do
  before do
    # run before each test
    @instance = VictorOpsClient::AddTeamPayload.new
  end
  ...
  describe 'test an instance of AddTeamPayload' do
    it 'should create an instance of AddTeamPayload' do
      expect(@instance).to be_instance_of(VictorOpsClient::AddTeamPayload)
    end
  end
