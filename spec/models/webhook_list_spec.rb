...
# Unit tests for VictorOpsClient::WebhookList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookList' do
  before do
    # run before each test
    @instance = VictorOpsClient::WebhookList.new
  end
  ...
  describe 'test an instance of WebhookList' do
    it 'should create an instance of WebhookList' do
      expect(@instance).to be_instance_of(VictorOpsClient::WebhookList)
    end
  end
