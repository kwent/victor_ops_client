...
# Unit tests for VictorOpsClient::ScheduledOverridePayload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScheduledOverridePayload' do
  before do
    # run before each test
    @instance = VictorOpsClient::ScheduledOverridePayload.new
  end
  ...
  describe 'test an instance of ScheduledOverridePayload' do
    it 'should create an instance of ScheduledOverridePayload' do
      expect(@instance).to be_instance_of(VictorOpsClient::ScheduledOverridePayload)
    end
  end
