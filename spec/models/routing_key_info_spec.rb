...
# Unit tests for VictorOpsClient::RoutingKeyInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RoutingKeyInfo' do
  before do
    # run before each test
    @instance = VictorOpsClient::RoutingKeyInfo.new
  end
  ...
  describe 'test an instance of RoutingKeyInfo' do
    it 'should create an instance of RoutingKeyInfo' do
      expect(@instance).to be_instance_of(VictorOpsClient::RoutingKeyInfo)
    end
  end
