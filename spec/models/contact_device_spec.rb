...
# Unit tests for VictorOpsClient::ContactDevice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContactDevice' do
  before do
    # run before each test
    @instance = VictorOpsClient::ContactDevice.new
  end
  ...
  describe 'test an instance of ContactDevice' do
    it 'should create an instance of ContactDevice' do
      expect(@instance).to be_instance_of(VictorOpsClient::ContactDevice)
    end
  end
