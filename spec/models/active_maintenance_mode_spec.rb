...
# Unit tests for VictorOpsClient::ActiveMaintenanceMode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ActiveMaintenanceMode' do
  before do
    # run before each test
    @instance = VictorOpsClient::ActiveMaintenanceMode.new
  end
  ...
  describe 'test an instance of ActiveMaintenanceMode' do
    it 'should create an instance of ActiveMaintenanceMode' do
      expect(@instance).to be_instance_of(VictorOpsClient::ActiveMaintenanceMode)
    end
  end
