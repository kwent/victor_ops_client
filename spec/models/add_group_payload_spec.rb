...
# Unit tests for VictorOpsClient::AddGroupPayload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddGroupPayload' do
  before do
    # run before each test
    @instance = VictorOpsClient::AddGroupPayload.new
  end
  ...
  describe 'test an instance of AddGroupPayload' do
    it 'should create an instance of AddGroupPayload' do
      expect(@instance).to be_instance_of(VictorOpsClient::AddGroupPayload)
    end
  end
