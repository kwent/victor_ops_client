...
# Unit tests for VictorOpsClient::OnCallOverride
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnCallOverride' do
  before do
    # run before each test
    @instance = VictorOpsClient::OnCallOverride.new
  end
  ...
  describe 'test an instance of OnCallOverride' do
    it 'should create an instance of OnCallOverride' do
      expect(@instance).to be_instance_of(VictorOpsClient::OnCallOverride)
    end
  end
  describe 'test attribute "orig_on_call_user"' do
    it 'should work' do
