...
# Unit tests for VictorOpsClient::NotificationObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificationObject' do
  before do
    # run before each test
    @instance = VictorOpsClient::NotificationObject.new
  end
  ...
  describe 'test an instance of NotificationObject' do
    it 'should create an instance of NotificationObject' do
      expect(@instance).to be_instance_of(VictorOpsClient::NotificationObject)
    end
  end
