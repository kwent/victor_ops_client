...
# Unit tests for VictorOpsClient::Policies
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Policies' do
  before do
    # run before each test
    @instance = VictorOpsClient::Policies.new
  end
  ...
  describe 'test an instance of Policies' do
    it 'should create an instance of Policies' do
      expect(@instance).to be_instance_of(VictorOpsClient::Policies)
    end
  end
