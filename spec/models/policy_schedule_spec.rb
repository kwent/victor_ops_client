...
# Unit tests for VictorOpsClient::PolicySchedule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicySchedule' do
  before do
    # run before each test
    @instance = VictorOpsClient::PolicySchedule.new
  end
  ...
  describe 'test an instance of PolicySchedule' do
    it 'should create an instance of PolicySchedule' do
      expect(@instance).to be_instance_of(VictorOpsClient::PolicySchedule)
    end
  end
