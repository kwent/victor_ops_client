...
# Unit tests for VictorOpsClient::AckOrResolveRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AckOrResolveRequest' do
  before do
    # run before each test
    @instance = VictorOpsClient::AckOrResolveRequest.new
  end
  ...
  describe 'test an instance of AckOrResolveRequest' do
    it 'should create an instance of AckOrResolveRequest' do
      expect(@instance).to be_instance_of(VictorOpsClient::AckOrResolveRequest)
    end
  end
  ...
  describe 'test attribute "incident_names"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
