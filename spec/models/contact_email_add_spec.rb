...
# Unit tests for VictorOpsClient::ContactEmailAdd
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContactEmailAdd' do
  before do
    # run before each test
    @instance = VictorOpsClient::ContactEmailAdd.new
  end
  ...
  describe 'test an instance of ContactEmailAdd' do
    it 'should create an instance of ContactEmailAdd' do
      expect(@instance).to be_instance_of(VictorOpsClient::ContactEmailAdd)
    end
  end
