...
# Unit tests for VictorOpsClient::TimeoutDescription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimeoutDescription' do
  before do
    # run before each test
    @instance = VictorOpsClient::TimeoutDescription.new
  end
  ...
  describe 'test an instance of TimeoutDescription' do
    it 'should create an instance of TimeoutDescription' do
      expect(@instance).to be_instance_of(VictorOpsClient::TimeoutDescription)
    end
  end
end
