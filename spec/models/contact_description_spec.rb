...
# Unit tests for VictorOpsClient::ContactDescription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContactDescription' do
  before do
    # run before each test
    @instance = VictorOpsClient::ContactDescription.new
  end
  ...
  describe 'test an instance of ContactDescription' do
    it 'should create an instance of ContactDescription' do
      expect(@instance).to be_instance_of(VictorOpsClient::ContactDescription)
    end
  end
end
