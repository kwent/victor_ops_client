...
# Unit tests for VictorOpsClient::OnCallType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnCallType' do
  before do
    # run before each test
    @instance = VictorOpsClient::OnCallType.new
  end
  ...
  describe 'test an instance of OnCallType' do
    it 'should create an instance of OnCallType' do
      expect(@instance).to be_instance_of(VictorOpsClient::OnCallType)
    end
  end
end
