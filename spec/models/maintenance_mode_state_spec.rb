...
# Unit tests for VictorOpsClient::MaintenanceModeState
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MaintenanceModeState' do
  before do
    # run before each test
    @instance = VictorOpsClient::MaintenanceModeState.new
  end
  ...
  describe 'test an instance of MaintenanceModeState' do
    it 'should create an instance of MaintenanceModeState' do
      expect(@instance).to be_instance_of(VictorOpsClient::MaintenanceModeState)
    end
  end
  ...
  describe 'test attribute "active_instances"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
