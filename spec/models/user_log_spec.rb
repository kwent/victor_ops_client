...
# Unit tests for VictorOpsClient::UserLog
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserLog' do
  before do
    # run before each test
    @instance = VictorOpsClient::UserLog.new
  end
  ...
  describe 'test an instance of UserLog' do
    it 'should create an instance of UserLog' do
      expect(@instance).to be_instance_of(VictorOpsClient::UserLog)
    end
  end
