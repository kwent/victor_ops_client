...
# Unit tests for VictorOpsClient::UserTeamsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserTeamsResponse' do
  before do
    # run before each test
    @instance = VictorOpsClient::UserTeamsResponse.new
  end
  ...
  describe 'test an instance of UserTeamsResponse' do
    it 'should create an instance of UserTeamsResponse' do
      expect(@instance).to be_instance_of(VictorOpsClient::UserTeamsResponse)
    end
  end
