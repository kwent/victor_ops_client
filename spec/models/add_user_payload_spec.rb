...
# Unit tests for VictorOpsClient::AddUserPayload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddUserPayload' do
  before do
    # run before each test
    @instance = VictorOpsClient::AddUserPayload.new
  end
  ...
  describe 'test an instance of AddUserPayload' do
    it 'should create an instance of AddUserPayload' do
      expect(@instance).to be_instance_of(VictorOpsClient::AddUserPayload)
    end
  end
  ...
  describe 'test attribute "expiration_hours"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
