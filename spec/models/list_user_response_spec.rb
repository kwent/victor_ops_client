...
# Unit tests for VictorOpsClient::ListUserResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListUserResponse' do
  before do
    # run before each test
    @instance = VictorOpsClient::ListUserResponse.new
  end
  ...
  describe 'test an instance of ListUserResponse' do
    it 'should create an instance of ListUserResponse' do
      expect(@instance).to be_instance_of(VictorOpsClient::ListUserResponse)
    end
  end
