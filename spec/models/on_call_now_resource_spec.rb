...
# Unit tests for VictorOpsClient::OnCallNowResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnCallNowResource' do
  before do
    # run before each test
    @instance = VictorOpsClient::OnCallNowResource.new
  end
  ...
  describe 'test an instance of OnCallNowResource' do
    it 'should create an instance of OnCallNowResource' do
      expect(@instance).to be_instance_of(VictorOpsClient::OnCallNowResource)
    end
  end
