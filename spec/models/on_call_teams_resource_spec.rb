...
# Unit tests for VictorOpsClient::OnCallTeamsResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnCallTeamsResource' do
  before do
    # run before each test
    @instance = VictorOpsClient::OnCallTeamsResource.new
  end
  ...
  describe 'test an instance of OnCallTeamsResource' do
    it 'should create an instance of OnCallTeamsResource' do
      expect(@instance).to be_instance_of(VictorOpsClient::OnCallTeamsResource)
    end
  end
  ...
  describe 'test attribute "on_call_now"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
