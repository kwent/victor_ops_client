...
# Unit tests for VictorOpsClient::RoutingKeyPayload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RoutingKeyPayload' do
  before do
    # run before each test
    @instance = VictorOpsClient::RoutingKeyPayload.new
  end
  ...
  describe 'test an instance of RoutingKeyPayload' do
    it 'should create an instance of RoutingKeyPayload' do
      expect(@instance).to be_instance_of(VictorOpsClient::RoutingKeyPayload)
    end
  end
