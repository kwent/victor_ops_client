...
# Unit tests for VictorOpsClient::IncidentTransition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IncidentTransition' do
  before do
    # run before each test
    @instance = VictorOpsClient::IncidentTransition.new
  end
  ...
  describe 'test an instance of IncidentTransition' do
    it 'should create an instance of IncidentTransition' do
      expect(@instance).to be_instance_of(VictorOpsClient::IncidentTransition)
    end
  end
  ...
  describe 'test attribute "manually"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "alert_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
