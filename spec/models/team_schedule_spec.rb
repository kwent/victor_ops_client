...
# Unit tests for VictorOpsClient::TeamSchedule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TeamSchedule' do
  before do
    # run before each test
    @instance = VictorOpsClient::TeamSchedule.new
  end
  ...
  describe 'test an instance of TeamSchedule' do
    it 'should create an instance of TeamSchedule' do
      expect(@instance).to be_instance_of(VictorOpsClient::TeamSchedule)
    end
  end
