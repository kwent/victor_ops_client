...
# Unit tests for VictorOpsClient::ListTeamResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListTeamResponse' do
  before do
    # run before each test
    @instance = VictorOpsClient::ListTeamResponse.new
  end
  ...
  describe 'test an instance of ListTeamResponse' do
    it 'should create an instance of ListTeamResponse' do
      expect(@instance).to be_instance_of(VictorOpsClient::ListTeamResponse)
    end
  end
end
