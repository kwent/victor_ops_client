...
# Unit tests for VictorOpsClient::UpdateAssignment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateAssignment' do
  before do
    # run before each test
    @instance = VictorOpsClient::UpdateAssignment.new
  end
  ...
  describe 'test an instance of UpdateAssignment' do
    it 'should create an instance of UpdateAssignment' do
      expect(@instance).to be_instance_of(VictorOpsClient::UpdateAssignment)
    end
  end
  ...
  describe 'test attribute "accept_overlap"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
