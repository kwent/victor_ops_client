...
# Unit tests for VictorOpsClient::AckUser
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AckUser' do
  before do
    # run before each test
    @instance = VictorOpsClient::AckUser.new
  end
  ...
  describe 'test an instance of AckUser' do
    it 'should create an instance of AckUser' do
      expect(@instance).to be_instance_of(VictorOpsClient::AckUser)
    end
  end
