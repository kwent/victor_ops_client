...
# Unit tests for VictorOpsClient::TimeoutObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimeoutObject' do
  before do
    # run before each test
    @instance = VictorOpsClient::TimeoutObject.new
  end
  ...
  describe 'test an instance of TimeoutObject' do
    it 'should create an instance of TimeoutObject' do
      expect(@instance).to be_instance_of(VictorOpsClient::TimeoutObject)
    end
  end
