...
# Unit tests for VictorOpsClient::PagingPolicyStepRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PagingPolicyStepRule' do
  before do
    # run before each test
    @instance = VictorOpsClient::PagingPolicyStepRule.new
  end
  ...
  describe 'test an instance of PagingPolicyStepRule' do
    it 'should create an instance of PagingPolicyStepRule' do
      expect(@instance).to be_instance_of(VictorOpsClient::PagingPolicyStepRule)
    end
  end
