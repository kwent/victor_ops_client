...
# Unit tests for VictorOpsClient::ScheduledUser
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScheduledUser' do
  before do
    # run before each test
    @instance = VictorOpsClient::ScheduledUser.new
  end
  ...
  describe 'test an instance of ScheduledUser' do
    it 'should create an instance of ScheduledUser' do
      expect(@instance).to be_instance_of(VictorOpsClient::ScheduledUser)
    end
  end
