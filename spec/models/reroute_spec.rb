...
# Unit tests for VictorOpsClient::Reroute
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Reroute' do
  before do
    # run before each test
    @instance = VictorOpsClient::Reroute.new
  end
  ...
  describe 'test an instance of Reroute' do
    it 'should create an instance of Reroute' do
      expect(@instance).to be_instance_of(VictorOpsClient::Reroute)
    end
  end
  ...
  describe 'test attribute "add_targets"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
