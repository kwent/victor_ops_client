...
# Unit tests for VictorOpsClient::PagingPolicyStep
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PagingPolicyStep' do
  before do
    # run before each test
    @instance = VictorOpsClient::PagingPolicyStep.new
  end
  ...
  describe 'test an instance of PagingPolicyStep' do
    it 'should create an instance of PagingPolicyStep' do
      expect(@instance).to be_instance_of(VictorOpsClient::PagingPolicyStep)
    end
  end
