...
# Unit tests for VictorOpsClient::PagingPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PagingPolicy' do
  before do
    # run before each test
    @instance = VictorOpsClient::PagingPolicy.new
  end
  ...
  describe 'test an instance of PagingPolicy' do
    it 'should create an instance of PagingPolicy' do
      expect(@instance).to be_instance_of(VictorOpsClient::PagingPolicy)
    end
  end
