...
# Unit tests for VictorOpsClient::CreatedIncident
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreatedIncident' do
  before do
    # run before each test
    @instance = VictorOpsClient::CreatedIncident.new
  end
  ...
  describe 'test an instance of CreatedIncident' do
    it 'should create an instance of CreatedIncident' do
      expect(@instance).to be_instance_of(VictorOpsClient::CreatedIncident)
    end
  end
