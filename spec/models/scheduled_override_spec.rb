...
# Unit tests for VictorOpsClient::ScheduledOverride
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScheduledOverride' do
  before do
    # run before each test
    @instance = VictorOpsClient::ScheduledOverride.new
  end
  ...
  describe 'test an instance of ScheduledOverride' do
    it 'should create an instance of ScheduledOverride' do
      expect(@instance).to be_instance_of(VictorOpsClient::ScheduledOverride)
    end
  end
