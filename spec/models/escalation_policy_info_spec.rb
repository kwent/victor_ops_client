...
# Unit tests for VictorOpsClient::EscalationPolicyInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EscalationPolicyInfo' do
  before do
    # run before each test
    @instance = VictorOpsClient::EscalationPolicyInfo.new
  end
  ...
  describe 'test an instance of EscalationPolicyInfo' do
    it 'should create an instance of EscalationPolicyInfo' do
      expect(@instance).to be_instance_of(VictorOpsClient::EscalationPolicyInfo)
    end
  end
