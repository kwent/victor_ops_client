...
# Unit tests for VictorOpsClient::RotationGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RotationGroup' do
  before do
    # run before each test
    @instance = VictorOpsClient::RotationGroup.new
  end
  ...
  describe 'test an instance of RotationGroup' do
    it 'should create an instance of RotationGroup' do
      expect(@instance).to be_instance_of(VictorOpsClient::RotationGroup)
    end
  end
