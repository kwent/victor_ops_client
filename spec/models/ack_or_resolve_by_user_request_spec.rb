...
# Unit tests for VictorOpsClient::AckOrResolveByUserRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AckOrResolveByUserRequest' do
  before do
    # run before each test
    @instance = VictorOpsClient::AckOrResolveByUserRequest.new
  end
  ...
  describe 'test an instance of AckOrResolveByUserRequest' do
    it 'should create an instance of AckOrResolveByUserRequest' do
      expect(@instance).to be_instance_of(VictorOpsClient::AckOrResolveByUserRequest)
    end
  end
