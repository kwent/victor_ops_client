...
# Unit tests for VictorOpsClient::AddTeamResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddTeamResponse' do
  before do
    # run before each test
    @instance = VictorOpsClient::AddTeamResponse.new
  end
  ...
  describe 'test an instance of AddTeamResponse' do
    it 'should create an instance of AddTeamResponse' do
      expect(@instance).to be_instance_of(VictorOpsClient::AddTeamResponse)
    end
  end
end
