...
# Unit tests for VictorOpsClient::SubscriptionInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionInput' do
  before do
    # run before each test
    @instance = VictorOpsClient::SubscriptionInput.new
  end
  ...
  describe 'test an instance of SubscriptionInput' do
    it 'should create an instance of SubscriptionInput' do
      expect(@instance).to be_instance_of(VictorOpsClient::SubscriptionInput)
    end
  end
