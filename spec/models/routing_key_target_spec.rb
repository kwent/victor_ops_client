...
# Unit tests for VictorOpsClient::RoutingKeyTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RoutingKeyTarget' do
  before do
    # run before each test
    @instance = VictorOpsClient::RoutingKeyTarget.new
  end
  ...
  describe 'test an instance of RoutingKeyTarget' do
    it 'should create an instance of RoutingKeyTarget' do
      expect(@instance).to be_instance_of(VictorOpsClient::RoutingKeyTarget)
    end
  end
