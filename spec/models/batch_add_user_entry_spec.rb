...
# Unit tests for VictorOpsClient::BatchAddUserEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BatchAddUserEntry' do
  before do
    # run before each test
    @instance = VictorOpsClient::BatchAddUserEntry.new
  end
  ...
  describe 'test an instance of BatchAddUserEntry' do
    it 'should create an instance of BatchAddUserEntry' do
      expect(@instance).to be_instance_of(VictorOpsClient::BatchAddUserEntry)
    end
  end
