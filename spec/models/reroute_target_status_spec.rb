...
# Unit tests for VictorOpsClient::RerouteTargetStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RerouteTargetStatus' do
  before do
    # run before each test
    @instance = VictorOpsClient::RerouteTargetStatus.new
  end
  ...
  describe 'test an instance of RerouteTargetStatus' do
    it 'should create an instance of RerouteTargetStatus' do
      expect(@instance).to be_instance_of(VictorOpsClient::RerouteTargetStatus)
    end
  end
