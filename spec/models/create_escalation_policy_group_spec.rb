...
# Unit tests for VictorOpsClient::CreateEscalationPolicyGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateEscalationPolicyGroup' do
  before do
    # run before each test
    @instance = VictorOpsClient::CreateEscalationPolicyGroup.new
  end
  ...
  describe 'test an instance of CreateEscalationPolicyGroup' do
    it 'should create an instance of CreateEscalationPolicyGroup' do
      expect(@instance).to be_instance_of(VictorOpsClient::CreateEscalationPolicyGroup)
    end
  end
