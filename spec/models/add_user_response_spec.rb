...
# Unit tests for VictorOpsClient::AddUserResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddUserResponse' do
  before do
    # run before each test
    @instance = VictorOpsClient::AddUserResponse.new
  end
  ...
  describe 'test an instance of AddUserResponse' do
    it 'should create an instance of AddUserResponse' do
      expect(@instance).to be_instance_of(VictorOpsClient::AddUserResponse)
    end
  end
end
