...
# Unit tests for VictorOpsClient::OnCallAndOverrides
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnCallAndOverrides' do
  before do
    # run before each test
    @instance = VictorOpsClient::OnCallAndOverrides.new
  end
  ...
  describe 'test an instance of OnCallAndOverrides' do
    it 'should create an instance of OnCallAndOverrides' do
      expect(@instance).to be_instance_of(VictorOpsClient::OnCallAndOverrides)
    end
  end
