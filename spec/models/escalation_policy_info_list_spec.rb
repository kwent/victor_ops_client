...
# Unit tests for VictorOpsClient::EscalationPolicyInfoList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EscalationPolicyInfoList' do
  before do
    # run before each test
    @instance = VictorOpsClient::EscalationPolicyInfoList.new
  end
  ...
  describe 'test an instance of EscalationPolicyInfoList' do
    it 'should create an instance of EscalationPolicyInfoList' do
      expect(@instance).to be_instance_of(VictorOpsClient::EscalationPolicyInfoList)
    end
  end
