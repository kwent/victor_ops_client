...
# Unit tests for VictorOpsClient::OnCallLog
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnCallLog' do
  before do
    # run before each test
    @instance = VictorOpsClient::OnCallLog.new
  end
  ...
  describe 'test an instance of OnCallLog' do
    it 'should create an instance of OnCallLog' do
      expect(@instance).to be_instance_of(VictorOpsClient::OnCallLog)
    end
  end
  ...
  describe 'test attribute "user_logs"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
