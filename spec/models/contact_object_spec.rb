...
# Unit tests for VictorOpsClient::ContactObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContactObject' do
  before do
    # run before each test
    @instance = VictorOpsClient::ContactObject.new
  end
  ...
  describe 'test an instance of ContactObject' do
    it 'should create an instance of ContactObject' do
      expect(@instance).to be_instance_of(VictorOpsClient::ContactObject)
    end
  end
