...
# Unit tests for VictorOpsClient::AddTeamMemberPayload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddTeamMemberPayload' do
  before do
    # run before each test
    @instance = VictorOpsClient::AddTeamMemberPayload.new
  end
  ...
  describe 'test an instance of AddTeamMemberPayload' do
    it 'should create an instance of AddTeamMemberPayload' do
      expect(@instance).to be_instance_of(VictorOpsClient::AddTeamMemberPayload)
    end
  end
