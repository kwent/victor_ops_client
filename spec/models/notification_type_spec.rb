...
# Unit tests for VictorOpsClient::NotificationType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificationType' do
  before do
    # run before each test
    @instance = VictorOpsClient::NotificationType.new
  end
  ...
  describe 'test an instance of NotificationType' do
    it 'should create an instance of NotificationType' do
      expect(@instance).to be_instance_of(VictorOpsClient::NotificationType)
    end
  end
end
