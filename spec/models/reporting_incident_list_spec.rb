...
# Unit tests for VictorOpsClient::ReportingIncidentList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReportingIncidentList' do
  before do
    # run before each test
    @instance = VictorOpsClient::ReportingIncidentList.new
  end
  ...
  describe 'test an instance of ReportingIncidentList' do
    it 'should create an instance of ReportingIncidentList' do
      expect(@instance).to be_instance_of(VictorOpsClient::ReportingIncidentList)
    end
  end
