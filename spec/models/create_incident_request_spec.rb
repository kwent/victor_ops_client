...
# Unit tests for VictorOpsClient::CreateIncidentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateIncidentRequest' do
  before do
    # run before each test
    @instance = VictorOpsClient::CreateIncidentRequest.new
  end
  ...
  describe 'test an instance of CreateIncidentRequest' do
    it 'should create an instance of CreateIncidentRequest' do
      expect(@instance).to be_instance_of(VictorOpsClient::CreateIncidentRequest)
    end
  end
  ...
  describe 'test attribute "is_multi_responder"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
