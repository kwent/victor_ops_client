...
# Unit tests for VictorOpsClient::IncidentList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IncidentList' do
  before do
    # run before each test
    @instance = VictorOpsClient::IncidentList.new
  end
  ...
  describe 'test an instance of IncidentList' do
    it 'should create an instance of IncidentList' do
      expect(@instance).to be_instance_of(VictorOpsClient::IncidentList)
    end
  end
