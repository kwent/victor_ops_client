...
# Unit tests for VictorOpsClient::EscalationPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EscalationPolicy' do
  before do
    # run before each test
    @instance = VictorOpsClient::EscalationPolicy.new
  end
  ...
  describe 'test an instance of EscalationPolicy' do
    it 'should create an instance of EscalationPolicy' do
      expect(@instance).to be_instance_of(VictorOpsClient::EscalationPolicy)
    end
  end
