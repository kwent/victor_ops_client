...
# Unit tests for VictorOpsClient::TakeResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TakeResult' do
  before do
    # run before each test
    @instance = VictorOpsClient::TakeResult.new
  end
  ...
  describe 'test an instance of TakeResult' do
    it 'should create an instance of TakeResult' do
      expect(@instance).to be_instance_of(VictorOpsClient::TakeResult)
    end
  end
