...
# Unit tests for VictorOpsClient::RerouteStatusResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RerouteStatusResponse' do
  before do
    # run before each test
    @instance = VictorOpsClient::RerouteStatusResponse.new
  end
  ...
  describe 'test an instance of RerouteStatusResponse' do
    it 'should create an instance of RerouteStatusResponse' do
      expect(@instance).to be_instance_of(VictorOpsClient::RerouteStatusResponse)
    end
  end
