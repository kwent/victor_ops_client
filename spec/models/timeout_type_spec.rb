...
# Unit tests for VictorOpsClient::TimeoutType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimeoutType' do
  before do
    # run before each test
    @instance = VictorOpsClient::TimeoutType.new
  end
  ...
  describe 'test an instance of TimeoutType' do
    it 'should create an instance of TimeoutType' do
      expect(@instance).to be_instance_of(VictorOpsClient::TimeoutType)
    end
  end
end
