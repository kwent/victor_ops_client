...
# Unit tests for VictorOpsClient::AddStepPayload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddStepPayload' do
  before do
    # run before each test
    @instance = VictorOpsClient::AddStepPayload.new
  end
  ...
  describe 'test an instance of AddStepPayload' do
    it 'should create an instance of AddStepPayload' do
      expect(@instance).to be_instance_of(VictorOpsClient::AddStepPayload)
    end
  end
