...
# Unit tests for VictorOpsClient::IncidentTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IncidentTarget' do
  before do
    # run before each test
    @instance = VictorOpsClient::IncidentTarget.new
  end
  ...
  describe 'test an instance of IncidentTarget' do
    it 'should create an instance of IncidentTarget' do
      expect(@instance).to be_instance_of(VictorOpsClient::IncidentTarget)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["User", "EscalationPolicy"])
