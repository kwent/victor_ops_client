...
# Unit tests for VictorOpsClient::ContactPhoneAdd
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContactPhoneAdd' do
  before do
    # run before each test
    @instance = VictorOpsClient::ContactPhoneAdd.new
  end
  ...
  describe 'test an instance of ContactPhoneAdd' do
    it 'should create an instance of ContactPhoneAdd' do
      expect(@instance).to be_instance_of(VictorOpsClient::ContactPhoneAdd)
    end
  end
