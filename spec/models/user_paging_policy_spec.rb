...
# Unit tests for VictorOpsClient::UserPagingPolicy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserPagingPolicy' do
  before do
    # run before each test
    @instance = VictorOpsClient::UserPagingPolicy.new
  end
  ...
  describe 'test an instance of UserPagingPolicy' do
    it 'should create an instance of UserPagingPolicy' do
      expect(@instance).to be_instance_of(VictorOpsClient::UserPagingPolicy)
    end
  end
end
