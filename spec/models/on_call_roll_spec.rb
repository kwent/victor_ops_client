...
# Unit tests for VictorOpsClient::OnCallRoll
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnCallRoll' do
  before do
    # run before each test
    @instance = VictorOpsClient::OnCallRoll.new
  end
  ...
  describe 'test an instance of OnCallRoll' do
    it 'should create an instance of OnCallRoll' do
      expect(@instance).to be_instance_of(VictorOpsClient::OnCallRoll)
    end
  end
