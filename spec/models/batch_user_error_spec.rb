...
# Unit tests for VictorOpsClient::BatchUserError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BatchUserError' do
  before do
    # run before each test
    @instance = VictorOpsClient::BatchUserError.new
  end
  ...
  describe 'test an instance of BatchUserError' do
    it 'should create an instance of BatchUserError' do
      expect(@instance).to be_instance_of(VictorOpsClient::BatchUserError)
    end
  end
