...
# Unit tests for VictorOpsClient::UserSchedule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserSchedule' do
  before do
    # run before each test
    @instance = VictorOpsClient::UserSchedule.new
  end
  ...
  describe 'test an instance of UserSchedule' do
    it 'should create an instance of UserSchedule' do
      expect(@instance).to be_instance_of(VictorOpsClient::UserSchedule)
    end
  end
  describe 'test attribute "team_schedules"' do
    it 'should work' do
