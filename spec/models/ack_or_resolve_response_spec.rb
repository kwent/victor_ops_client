...
# Unit tests for VictorOpsClient::AckOrResolveResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AckOrResolveResponse' do
  before do
    # run before each test
    @instance = VictorOpsClient::AckOrResolveResponse.new
  end
  ...
  describe 'test an instance of AckOrResolveResponse' do
    it 'should create an instance of AckOrResolveResponse' do
      expect(@instance).to be_instance_of(VictorOpsClient::AckOrResolveResponse)
    end
  end
