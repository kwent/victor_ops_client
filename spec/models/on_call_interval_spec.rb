...
# Unit tests for VictorOpsClient::OnCallInterval
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OnCallInterval' do
  before do
    # run before each test
    @instance = VictorOpsClient::OnCallInterval.new
  end
  ...
  describe 'test an instance of OnCallInterval' do
    it 'should create an instance of OnCallInterval' do
      expect(@instance).to be_instance_of(VictorOpsClient::OnCallInterval)
    end
  end
  ...
  describe 'test attribute "off"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
