...
# Unit tests for VictorOpsClient::EscalationPolicyGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EscalationPolicyGroup' do
  before do
    # run before each test
    @instance = VictorOpsClient::EscalationPolicyGroup.new
  end
  ...
  describe 'test an instance of EscalationPolicyGroup' do
    it 'should create an instance of EscalationPolicyGroup' do
      expect(@instance).to be_instance_of(VictorOpsClient::EscalationPolicyGroup)
    end
  end
